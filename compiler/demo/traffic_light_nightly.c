...
static const transref_t night_service_trans_out [] = { 1, 2 };
static const transref_t night_service_trans_out_inh [] = { 2, 3, 4 };

static const transref_t green_trans_out [] = { 1, 5 };
